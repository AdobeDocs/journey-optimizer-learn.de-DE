...
3. Sie können die nächsten beiden Bildschirme überspringen:
   ...
   <br>
   ![Personalization-Popup](/help/summit/l820-lab-workbook/assets/2-1-4-ajo-personalization-pop-up.png)
...
>
>![Kampagne mit benutzerdefiniertem Trigger definiert](/help/summit/l820-lab-workbook/assets/3-1-2-2-campaign-with-custom-trigger.png)
...
4. Geben Sie in das Textfeld den Wert für den benutzerdefinierten Trigger ein, den Sie in Campaign definiert haben. Klicken Sie dann auf Senden.
   ...
   ![Ändern](/help/summit/l820-lab-workbook/assets/3-2-2-1-app-condition.PNG){width="250" align="center" zoomable="yes"}
...
1. Klicken Sie als Nächstes auf **[!UICONTROL Start]** im Bildschirm Mit Gerät verbinden .
   ...
   ![Start-Schaltfläche](/help/summit/l820-lab-workbook/assets/3-3-1-2-connect-to-device-start.png)
   <br>
