...
+ Übungen, Labs und Herausforderungen {#exercises-and-challenges}
   ...
   + Summit Labs {#summit-labs}
      + [Erstellen personalisierter Mobile-Momente mit Adobe Journey Optimizer (2024)](/help/summit-lab-2024/l820-lab-workbook/lab-overview.md){target="_blank"}
      + [Skalierung der Orchestrierung auf eine Omni-Channel-Interaktion in Adobe Journey Optimizer (2025)](/help/summit-lab-2025/introduction.md){target="_blank"}
