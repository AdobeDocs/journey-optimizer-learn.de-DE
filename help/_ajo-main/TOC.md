...
source-git-commit: ee817f08906ccc99dcd4db3e443eb496555fe87a
workflow-type: tm+mt
...
+ Einführung in Journey Optimizer {#introduction-to-journey-optimizer}
  ...
  + {hide-from-toc}[Architektur](/help/introduction/architecture.md)
...
+ [Journey Optimizer – Mobiler Lern-Hub](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/mobile-learning-hub/overview){target="_blank"}
+ Kampagnen {#create-campaigns}
  + Aktionskampagnen {#action-campaigns}
    ...
    + [Erstellen einer In-App-Kampagne](/help/campaigns/action-campaigns/in-app.md)
  ...
  + Orchestrierte Kampagnen {#orchestrated-campaigns}
    ...
    + [Einrichten von Schemata und Datensätzen für orchestrierte Kampagnen](/help/campaigns/orchestrated-campaigns/set-up-schemas-and-datasets-for-orchestrated-campaigns.md)
    + [Erstellen einer orchestrierten Kampagne](/help/campaigns/orchestrated-campaigns/build-an-orchestrated-campaign.md)
+ Journeys {#journeys}
...
+ [Treue](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/loyalty/discover-journey-optimizer-loyalty)
...
+ Profile, Zielgruppen und Abonnements {#profiles-audiences-subscriptions}
  ...
  + {hide-from-toc}[Einheitliches Profil und Segmentierung – Überblick](/help/profiles-audiences-subscriptions/unified-profile-and-segmentation-overview.md)
...
+ Kanäle {#channels}
  ...
  + Direkt-Mail-Kanal{#direct-mail-channel}
    + [Erstellen von Direkt-Mail](/help/channels/direct-mail.md)
    + [Senden von Direkt-Mail-Nachrichten mit Journeys](/help/channels/direct-mail-in-journeys.md)
  ...
  + Push-Kanal{#push-channel}
    ...
    + [Erstellen von Web-Push-Benachrichtigungen](/help/channels/create-web-push-notifications.md)
    + [End-to-End-Tutorial zu Web-Push](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/ajo-web-push/introduction)
  + SMS-/MMS-Kanal{#sms-channel}
  ...
  + WhatsApp {#whatsapp}
    + {hide-from-toc}[Erste Schritte mit WhatsApp (End-to-End)](/help/channels/get-started-with-whatsapp-in-ajo.md)
  ...
  + [Konfigurieren und Verwenden benutzerdefinierter Kanäle](/help/channels/configure-and-use-custom-channels.md)
+ Content-Management{#content-management}
  ...
  + Arbeiten mit Fragmenten {#fragments}
    ...
    + [Verwenden von AEM-Inhaltsfragmenten (Managed Services)](/help/content-management/aem-content-fragments-managed-services.md)
...
+ Entscheidungsfunktionen{#decision-capabilities}
  + Entscheidungsfindung {#decisioning}
    + Grundlagen der Entscheidungsfindung {#fundamentals}
      ...
      + [Wiederverwendbare Regeln](/help/decisioning/reusable-targeting-rules.md)
      + [Verwenden von Rangfolgenformeln zum Bereitstellen von personalisierten Angeboten](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/personalizing-offers-with-ranking-formulas-based-on-user-zip-code-and-income/introduction){target="_blank"}
      + [KI-Modellerkenntnisse](/help/decisioning/ai-model-insights.md)
    + Verwenden von Entscheidungsfindung zum Personalisieren von Nachrichten {#use-decisioning}
      + [Einführung in die E-Mail-Entscheidungsfindung](/help/decisioning/introduction-to-decisioning-in-emails.md)
    ...
    + Auslösen von Entscheidungen durch externe Trigger und Interaktionen {#trigger}
      ...
      + [Personalisieren von Angeboten mit Echtzeitwetterdaten](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/personalizing-offers-with-real-time-weather-data/introduction){target="_blank"}
  + Entscheidungs-Management {#decision-management}
    ...
    + [Erstellen von personalisierten Angeboten](/help/decision-management/create-personalized-offers.md)
...
+ Berichte und Überwachung {#report-and-monitor}
  ...
  + [Überwachen benutzerdefinierter Aktionen](/help/report-and-monitor/custom-action-monitoring-report.md)
...
+ Konfiguration {#configuration}
  ...
  + Geschäftsregeln {#business-rules}
    ...
    + {hide-from-toc}[Tests und Berichte zu Häufigkeitsregeln](/help/business-rules/test-and-report-on-frequency-rules.md)
+ Zugriffssteuerung {#access-control}
  + {hide-from-toc}[Zugriffsverwaltung](/help/set-up-access/access-management.md)
...
+ KI-Assistenten und AI Agents {#ai-assistant}
  ...
  + [Analysieren und Erstellen von Journeys mit Journey Agent](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/journeys/journey-agent-overview?lang=de)
  ...
  + [Planen von Zielgruppen mit Adobe Marketing Agent](/help/ai-agents/plan-audiences-using-adobe-marketing-agent.md)
...
+ Übungen, Labs und Challenges {#exercises-and-challenges}
  ...
  + [Challenges](https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/challenges/introduction-and-prerequisites){target="_blank"}
