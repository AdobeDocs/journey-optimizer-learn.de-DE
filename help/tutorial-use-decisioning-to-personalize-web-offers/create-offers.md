...
Ein Angebotselement in AJO stellt einen einzelnen Teil des personalisierten Inhalts dar, z. B. eine Promotion, eine Nachricht oder eine Empfehlung, die einem Benutzer auf der Grundlage der Entscheidungslogik bereitgestellt wird.

Wenn Sie ein Angebotselement in AJO erstellen, muss es auf einem Entscheidungsschema basieren, das die Struktur und die im Angebot verfügbaren Felder definiert, z. B. Titel, Beschreibung, imageURL, offerText usw.
...
* Decisioning -> Kataloge -> Schema bearbeiten
* Fügen Sie ein Element des Typs „String“ mit dem Namen offerItem hinzu, wie unten dargestellt

  ![decisioning-schema](assets/offer-schema.png)

## Angebotselement erstellen

* Decisioning -> Kataloge -> Element erstellen

* Erstellen Sie drei Angebote: „Love Stocks“, „Love Bonds“ und „Love CD“. Kopieren Sie für jedes Angebot den entsprechenden Angebotstext am Ende dieses Artikels und fügen Sie ihn in das entsprechende Angebotselement ein.



* Taggen Sie die Angebote mit dem im vorherigen Schritt erstellten Tag.
