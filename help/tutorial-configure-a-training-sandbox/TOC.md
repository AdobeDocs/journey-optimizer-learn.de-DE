...
+ Schritt 1: Einrichten der Datenstruktur und Aufnehmen von Daten {#set-up-data-structure-and-ingest-data}
   + [Einrichten der Datenstruktur (manuell)](/help/tutorial-configure-a-training-sandbox/manual-data-set-up.md)
   + [Aufnehmen von Daten (manuell)](/help/tutorial-configure-a-training-sandbox/manual-data-ingestion.md)
