...
> - [Engineeringdaten für die intelligente Journey-Aktivierung in Adobe Journey Optimizer](https://experienceleague.adobe.com/en/courses/ajo-engineer-data-for-intelligent-journey-activation)
...
| Einverständnis | Einverständnis für Edge Network | Erfasst und erzwingt User Zustimmungseinstellungen. |
| Assurance | Adobe Experience Platform Assurance | Wird verwendet, um die SDK- und Kanal-Konfiguration durchgängig zu validieren und zu Debugging. |

>[!TAB Kanal-spezifisch]

#### Kanal-spezifische Erweiterungen für Journey Optimizer

| Kanal/Funktion | Zusätzliche wichtige Erweiterungen (zusätzlich zum Core) | Was sie ermöglichen |
|------------------------|---------------------------------------------------------------------|------------------|
| Push-Benachrichtigungen  | Mobile Journey Optimizer-Erweiterung (Push) | Push-Token registrieren und aktualisieren, Push-Tracking-Ereignisse senden, eine Verbindung zur AJO-Push-Konfiguration herstellen. |
...
Sie können diese Mobile-Eigenschaft manuell erstellen und konfigurieren oder **[Geführte Kanaleinrichtung](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup)** verwenden, um die erforderliche Tag-Eigenschaft, den Datenstrom und die Kanalkonfiguration für iOS oder Android automatisch zu erstellen.

> **Tipp**\
> Für neue Implementierungen **[ist die Kanal Einrichtung](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup)** der empfohlene Ausgangspunkt. Es reduziert das Risiko von falsch konfigurierten Datenströmen oder fehlenden Erweiterungen und führt Sie durch SDK-Tauglichkeitsprüfung mit Sicherheit.

#### Erste Schritte mit dem Mobile SDK:
...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/mobile-sdk/overview" title="Übersicht über Adobe Experience Platform Mobile SDK" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/28948?format=jpeg&nocache=1763594622398" alt="Übersicht über Adobe Experience Platform Mobile SDK"
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/platform-learn/data-collection/mobile-sdk/overview" target="_blank" rel="referrer" title="Adobe Experience Platform Mobile SDK – Übersicht">Adobe Experience Platform Mobile SDK – Übersicht</a>
                    </p>
                    <p class="is-size-6">Erfahren Sie, wie Adobe Experience Platform Mobile SDK End-to-End-Interaktion in Ihren mobilen Anwendungen unterstützt.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Adobe Experience Platform Mobile SDK Documentation">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/mobile" title="Dokumentation zu Adobe Experience Platform Mobile SDK" target="_blank" rel="referrer">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/mobile" target="_blank" rel="referrer" title="Dokumentation zu Adobe Experience Platform Mobile SDK">Dokumentation zu Adobe Experience Platform Mobile SDK</a>
                    </p>
...
Weitere Informationen finden Sie auch in der Dokumentation zu [Adobe Experience Platform Mobile SDK](https://experienceleague.adobe.com/en/docs/mobile)
...
- [Erste Schritte mit mobilen Eigenschaft (Tags)](https://developer.adobe.com/client-sdks/home/getting-started/create-a-mobile-property/)
- [SDK abrufen (in App installieren)](https://developer.adobe.com/client-sdks/home/getting-started/get-the-sdk/)
- [Verfolgen von Ereignissen mit dem Mobile SDK](https://developer.adobe.com/client-sdks/home/getting-started/track-events/)
- [Mit Assurance validieren](https://developer.adobe.com/client-sdks/home/base/assurance/)

#### Checkliste für Mobile SDK-Bereitschaft

> - [ ] Installiertes Core-SDK (Core, Edge, Identity, Consent, Assurance).
> - [ ] Mobile Journey Optimizer-Erweiterungen wurden für die Kanäle hinzugefügt, die Sie verwenden möchten (Push, In-App, Inhalte-Karten, codebasiert).
> - [ ] Datenstrom korrekt konfiguriert, um Datensätze zu Ereignis und Profil.
> - [ ] Identität und Zustimmung mit Assurance implementiert und validiert.
...
<div class="columns">
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Guided channel setup">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup" title="Geführte Kanaleinrichtung" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3433053/?format=jpeg&nocache=1763594622823" alt="Geführte Kanaleinrichtung"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/web-and-mobile-channels/guided-channel-setup" target="_blank" rel="referrer" title="Geführte Kanaleinrichtung">Anleitung zur Kanaleinrichtung</a>
                    </p>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/whatsapp-channel/set-up-whatsapp-channel" title="Einrichten des WhatsApp-Kanals" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3470268/?format=jpeg&nocache=1763594622814" alt="Einrichten des WhatsApp-Kanals"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
...
Konfigurieren Sie **die SMS/MMS/RCS-Kanäle** mit den Standardanbietern (Twilio, Synch oder Infobip) oder mit einem benutzerdefinierten SMS-Anbieter:
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/sms-mms-channel/configure-mms-api-credentials-and-channel-surfaces" title="Konfigurieren von MMS-API-Anmeldeinformationen und Kanaloberflächen" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3428872/?format=jpeg&nocache=1763594624083" alt="Konfigurieren von MMS-API-Anmeldeinformationen und Kanaloberflächen"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/configuration/channel-configuration/sms-mms-channel/set-up-rcs" title="Einrichten von RCS in Journey Optimizer" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3464755/?format=jpeg&nocache=1763594624043" alt="Einrichten von RCS in Journey Optimizer"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/data-governance-framework" title="Übersicht über das Data-Governance-Framework" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/29708/?format=jpeg&nocache=1763594624934" alt="Übersicht über das Data-Governance-Framework"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/classify-data-using-lables" title="Klassifizieren von Daten mithilfe von Labels" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/29709?format=jpeg&nocache=1763594624932" alt="Klassifizieren von Daten mithilfe von Labels"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/de/docs/journey-optimizer-learn/tutorials/data-governance-and-privacy/create-data-usage-policies" title="Erstellen von Richtlinien zur Datennutzung" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/32977/?format=jpeg&nocache=1763594624933" alt="Erstellen von Richtlinien zur Datennutzung"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
...
- Assurance zeigt fehlende Journey Optimizer-, Edge- oder Identitätserweiterungen an.

**Worauf zu achten ist**

- Verwenden Sie die Mindestversionen **der Mobile Core-** und **Journey Optimizer-Erweiterungen** , die für die geführte Kanal Einrichtung erforderlich sind?
- In **Assurance** unter Erweiterungen und Ereignissen:
   - Werden die erwarteten Erweiterungen geladen?
   - Werden Ereignisse an die Edge Network gesendet und quittiert?

**Beheben des Problems**

- Aktualisieren Sie auf die unterstützten Mobile SDK- und Journey Optimizer-Erweiterungsversionen.
- Erstellen Sie die App erneut, stellen Sie erneut eine Verbindung mit Assurance her und führen Sie die geführte Kanal-Einrichtung erneut aus.

Siehe: [Festlegen von Mobilgeräten und dem Web](https://experienceleague.adobe.com/de/docs/journey-optimizer/using/configuration/guided-setup/set-mobile-config)
...
Siehe: [Fluss von Push-Benachrichtigungen in Adobe Journey Optimizer](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channels/push/push-config/push-gs)
...
Siehe: [Implementieren des Einverständnisses für Implementierungen von Platform Mobile SDK](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/app-implementation/consent)
...
- Fügen Sie den Code hinzu, der:
   - Registriert das Token über die mobile Journey Optimizer-Erweiterung, wenn es erstellt oder aktualisiert wird.
...
- In-App-Nachrichten oder Inhalte-Karten werden trotz aktiver Kampagnen oder Journeys nie angezeigt.
- Die Berichterstellung zeigt 0 Impressionen.

**Worauf zu achten ist**

- Sind die mobile Messaging-/In-App-Erweiterung **und** das **Messaging-SDK** von Journey Optimizer in der App installiert und registriert?
- In Ihrer **Tags**-Konfiguration:
   - Sind Regeln vorhanden, die Anforderungen bei den richtigen Ereignissen auslösen (z. B. Bildschirmansichten oder benutzerdefinierte Ereignisse)?
- In **Assurance**:
   - Wenn diese Ereignisse ausgelöst werden, werden dann Anfragen zu Entscheidungen in der App oder Inhalte Karte gesendet?
   - Sehen Sie Antworten, die vom Edge-Netzwerk zurückgegeben werden?

**Beheben des Problems**

- Installieren und registrieren Sie die erforderlichen Messaging Erweiterungen.
- hinzufügen oder korrigieren Sie Regeln, die Entscheidungen zu Ihren Target-Komponente Ereignissen (Bildschirme, benutzerdefinierte Ereignisse) auslösen.
- Stellen Sie bei Inhalte Karten sicher, dass:
   - Holen Sie Karten über die Messaging-SDK-APIs.
   - Rendern Sie sie in Ihrem UI.
   - Verfolgen Sie Interaktionen über das SDK zurück.

Siehe:
- [Erstellen und Senden von In-App-Nachrichten](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/experience-cloud/journey-optimizer/journey-optimizer-inapp)
- [Konfigurieren der Unterstützung Inhalte Karten im Mobile SDK](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/channels/content-card/configure/content-card-lp)

</details>


## Checkliste für die Einzeilenbereitschaft
...
- Die SDK- und Journey Optimizer-Haupterweiterungen werden geladen,
- Ereignisse fließen im richtigen Datenstrom und in den richtigen Datensätzen ab,
- Identität und Einverständnis bei allen wichtigen Ereignissen vorhanden sind,
- Push-Token und Interaktionen werden verfolgt und
- Mindestens eine Test-In-App-Nachricht oder -Inhaltskarte wurde angezeigt und als