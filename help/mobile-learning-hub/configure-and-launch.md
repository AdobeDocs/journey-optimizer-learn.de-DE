...
### Erforderliche Mobile SDK-Komponenten für Journey Optimizer Mobile-Anwendungsfälle

Um Journey Optimizer Mobile-Kanäle (Push, In-App, Inhaltskarten, Code-basierte Erlebnisse) zu verwenden, müssen Sie die folgenden Erweiterungen installieren und konfigurieren:

![Erforderliche Erweiterungen](/help/mobile-learning-hub/assets/extensions.png)
