...
| Anwendungsfall | Beschreibung | Anwendungsbeispiel |
|---------|-------------|----------------------|
...
| **Upsell- und Crosssell-Kampagne** | Werbt für zusätzliche Produkte oder Upgrades bei Bestandskunden auf der Grundlage ihres Verhaltens, ihrer Voreinstellungen oder ihres Kaufverlaufs. | Fördern von Neuabonnements und Umsatzwachstum |
