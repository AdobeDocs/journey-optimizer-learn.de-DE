...
2. Erstellen Sie eine Journey namens `Luma – New Status – platinum`.
   ...
   3. Beim Hochladen der HTML-Datei stellen Sie fest, dass in der E-Mail vom Status „Diamant“ die Rede ist und nicht von „Platin“. Aktualisieren Sie die E-Mail im [!UICONTROL E-Mail-Designer], anstatt eine neue Datei vom Kreativ-Team anzufordern.
...
4. Wählen Sie **Auslösen eines Ereignisses** aus
